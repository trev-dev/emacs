...
I need to bootstrap straight.el in order to grab packages that are not available as Guix packages for whatever reason yet.
...
(straight-use-package '(org-contacts
                        :type git
                        :host "https://repo.or.cz/org-contacts.git"))
