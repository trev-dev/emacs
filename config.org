...
(use-package evil-goggles
  :straight t
  :custom-face
  (evil-goggles-default-face ((t (:foreground "#29424c" :background "#89DDFF"))))
  (evil-goggles-delete-face ((t (:foreground "#5b2b2b" :background "#f57373"))))
  (evil-goggles-paste-face ((t (:foreground "#58683f" :background "#c3e88d"))))
  :config
  (setq evil-goggles-duration 0.200)
  (setq evil-goggles-pulse nil)  ; Pulse doesn't seem to work consistently :/
  (evil-goggles-mode))
#+end_src
...
*** Eglot
Simpler, lighter LSP for emacs
#+begin_src emacs-lisp
(straight-use-package 'eglot)
(with-eval-after-load 'eglot
  (add-to-list 'eglot-server-programs '(php-mode . ("intelephense" "--stdio")))
  (dolist (mode '(php-mode-hook))
    (add-hook mode #'elgot-ensure)))
#+end_src
