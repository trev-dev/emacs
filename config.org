...
(defun td/org-voltage ()
  "Find voltage org files"
  (directory-files "/home/trevdev/Org/Voltage" t "\.org$"))
...
**** Custom Clock Table
I decided to write a [[file:td-custom-clocktable.el][custom clocktable formatter]]. I wanted a neat and tidy way to lay out the hours that I've worked, vs how much effort they should have taken & what that time should be worth when I invoice. I feel like this table is more useful for reporting to certain subcontracts.
