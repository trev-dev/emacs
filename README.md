...
To read more about how this configuration is supposed to work, see my [config strategy](#org10cf66c).
...
1.  [Configuration Strategy](#org10cf66c)
    1.  [Tangling Files](#orgf532f8a)
    2.  [Configuring Packages](#orgbf91e6d)
2.  [Early Init](#org662184c)
3.  [Init File Headers](#org586c9a2)
4.  [General Settings](#orgcde6502)
5.  [Helper Functions](#org46c75cc)
6.  [Priority Mode](#org7efc25a)
7.  [Keybinds](#orgec51731)
8.  [Prog Mode](#orgd0d0a4d)
9.  [Look & Feel](#org34c33a5)
    1.  [Dired](#org6e3bbd9)
    2.  [Custom Theme Devel](#org2a45f0b)
    3.  [Font Setup](#orgdb01249)
10. [Modeline](#orgdb24d31)
    1.  [Git status](#orga3b6206)
    2.  [Project indicator](#org6aeacff)
    3.  [Modal mode indicators](#org7eee312)
    4.  [God mode indicator](#orgce789dd)
    5.  [Buffer related info](#org46800ba)
    6.  [Various other package indicators](#orgb2a3887)
    7.  [Render a split-view mode-line](#org702484f)
    8.  [Diminish the minor-mode-alist](#org1e8b6b1)
11. [Utility Packages](#org3396720)
    1.  [Avy](#org6cb0d96)
    2.  [Anzu](#org0595feb)
    3.  [Completions](#orgdee8937)
    4.  [Denote](#org13f3c8c)
    5.  [Docker](#orgdeddf6b)
    6.  [Diff-hl](#org6d84df3)
    7.  [Ediff](#orge6b6f9a)
    8.  [Elfeed](#org03d7511)
    9.  [EMMS](#orgf00a4d3)
    10. [Surround](#org0f50c4c)
    11. [Ement](#orgc771da9)
    12. [ERC](#orgcdb9839)
    13. [Eshell](#org51171db)
    14. [Expand Region](#orge3d6171)
    15. [God Mode](#org7a67b64)
    16. [Goggles](#orgf851fbe)
    17. [Imenu](#org5f750cd)
    18. [Magit](#org21c5cec)
    19. [Mastodon](#org9d253a7)
    20. [Multiple Cursors](#orga2998aa)
    21. [Org](#org8d2505d)
    22. [Ledger](#orgbbba01c)
    23. [Vterm](#orgda58402)
    24. [Notmuch](#org2092083)
    25. [Password Store](#orgeade554)
    26. [Sensitive Mode](#orgfcbcf62)
    27. [RG](#org50708b5)
    28. [Transpose Mark](#org769e680)
    29. [Visual Fill Column](#org66df610)
    30. [Which-key](#org2320256)
    31. [Windmove](#org61cbc40)
12. [Syntax Support](#org9200d42)
    1.  [Clojure](#orgb6da3bf)
    2.  [Lisp](#orgc1c942a)
    3.  [CSS/SCSS](#org44dab9c)
    4.  [Emmet](#org0242c3e)
    5.  [Flycheck](#org39cf987)
    6.  [LSP Mode](#orgb9c9084)
    7.  [Markdown](#org743b946)
    8.  [Paredit](#org8cc0336)
    9.  [PHP](#orgdfdef4f)
    10. [Prettier](#org0801513)
    11. [Python](#org5e003ca)
    12. [Rainbow Delimiters](#org8f703c4)
    13. [Rainbow Mode](#org86922c2)
    14. [Ruby](#orgab4488f)
    15. [Rust](#org3f21b8b)
    16. [Shopify Liquid](#org320ff14)
    17. [Svelte](#orgae87664)
    18. [TypeScript & JavaScript](#org7490e15)
    19. [VueJS](#org3034b41)
    20. [Web Mode](#org7117ea0)
    21. [YAML](#org6b85e4c)
    22. [Yasnippet](#org9ac9c4e)
    23. [Load Customizer Settings](#orgc4524e8)
13. [Guix Package Module](#org6c7c417)
14. [Installation](#orgf4f357c)
15. [Licenses](#org26df2d5)
16. [Closing Thoughts](#orgaa97090)
...
For convenience, this file can be tangled to produce a Guile module, `emacs-d.scm`, which can serve as a useful reference for how to package the init configuration with its required dependencies. See [1.13](#org6c7c417) for more info.
...
I also want to appropriate `gnus-dired-attach` for use with [notmuch](#org2092083).
...
For more information, visit the [denote manual](https://protesilaos.com/emacs/denote).
...
7.  Apply & Finish Setup
    ...
    (with-eval-after-load 'god-mode
      ...
      (define-key isearch-mode-map (kbd "C-c g") #'god-mode-isearch-activate)
      (define-key god-mode-isearch-map (kbd "C-c g") #'god-mode-isearch-disable)
...
1.  Key Variables
    ...
    Capture templates! These help me collect information into Org files. Currently I only have 2 cookbook capture methods that are meant to be used with org-chef. See [extensions](#org962a177) for how I extend org-mode.
...
The popular `flycheck` package helps me lint various files. I use this in conjunction with [lsp-mode](#orgb9c9084) as the two are meant to work together.
...
I extend [web-mode](#org7117ea0) to enhance the syntax highlighting for `.svelte` files.
...
I extend [web-mode](#org7117ea0) to enhance highlighting in `.vue` files.
...
Load the file we created for custom vars in the [general settings](#orgcde6502).
