...
To read more about how this configuration is supposed to work, see my [config strategy](#org0e4d302).
...
1.  [Configuration Strategy](#org0e4d302)
    1.  [Tangling Files](#org0a64b09)
    2.  [Configuring Packages](#org9ae1619)
2.  [Early Init](#org11e111d)
3.  [Init File Headers](#org368b3cc)
4.  [General Settings](#org32db063)
5.  [Helper Functions](#org8e06fa7)
6.  [Priority Mode](#orgd9eb281)
7.  [Keybinds](#orgad5b3c1)
8.  [Prog Mode](#org1316289)
9.  [Look & Feel](#org78d0c2f)
    1.  [All The Icons](#orgfbffc08)
    2.  [Dired](#org2cd245b)
    3.  [Custom Theme Devel](#org39b856f)
    4.  [Font Setup](#orgeafb6e5)
10. [Modeline](#orgba5eaff)
    1.  [Git status](#org2cffe78)
    2.  [Project indicator](#orgd0ed3a8)
    3.  [Modal mode indicators](#org7ef6a1f)
    4.  [God mode indicator](#orgef8faf7)
    5.  [Buffer related info](#orgcc363a7)
    6.  [Various other package indicators](#org74f80f1)
    7.  [Render a split-view mode-line](#org726484d)
    8.  [Diminish the minor-mode-alist](#orgb993fb7)
11. [Utility Packages](#orga0e6937)
    1.  [Avy](#org9e63fb4)
    2.  [Anzu](#org681b704)
    3.  [Completions](#orgc02258a)
    4.  [Denote](#org1c5ba32)
    5.  [Docker](#org5b7b5e5)
    6.  [Diff-hl](#org1ee0a44)
    7.  [Ediff](#orgde379ce)
    8.  [Elfeed](#orge38bfce)
    9.  [EMMS](#orgebd5d94)
    10. [Surround](#org58fdbff)
    11. [Ement](#orgdca829f)
    12. [ERC](#org3f0d172)
    13. [Eshell](#org1f14ac9)
    14. [Expand Region](#org47611e8)
    15. [God Mode](#org0d99484)
    16. [Goggles](#orgcf57d2c)
    17. [Imenu](#orge617133)
    18. [Magit](#org5470e65)
    19. [Mastodon](#org2d7377f)
    20. [Multiple Cursors](#org748912e)
    21. [Org](#orgfa3bfe9)
    22. [Ledger](#orge0edda0)
    23. [Vterm](#org7277a9d)
    24. [Notmuch](#orgdee161c)
    25. [Password Store](#org806f5f6)
    26. [Sensitive Mode](#org45549b5)
    27. [RG](#orgc080bb6)
    28. [Visual Fill Column](#org0cbb0b3)
    29. [Which-key](#org45c2247)
    30. [Windmove](#org426d993)
12. [Syntax Support](#orge0d3c52)
    1.  [Clojure](#org55cc5b9)
    2.  [Lisp](#org356535b)
    3.  [CSS/SCSS](#orgbcc9572)
    4.  [Emmet](#org48a21f6)
    5.  [Flycheck](#org4324586)
    6.  [LSP Mode](#orgaf3bd61)
    7.  [Markdown](#org675d3fd)
    8.  [Paredit](#org252e90b)
    9.  [PHP](#org69f55f9)
    10. [Prettier](#orgdc61944)
    11. [Python](#orgab3fd3e)
    12. [Rainbow Delimiters](#org9fb8ce3)
    13. [Rainbow Mode](#org7eaf8b2)
    14. [Ruby](#org2d2ef52)
    15. [Rust](#org018df9d)
    16. [Shopify Liquid](#org802b22c)
    17. [Svelte](#org92ce406)
    18. [TypeScript & JavaScript](#org5737c5c)
    19. [VueJS](#orgc262946)
    20. [Web Mode](#orgcffb28f)
    21. [YAML](#orgf607fc1)
    22. [Yasnippet](#orga4c7ff4)
    23. [Load Customizer Settings](#orgcbfb2cf)
13. [Guix Package Module](#orgfabaee3)
14. [Installation](#orge3f3415)
15. [Licenses](#org5268029)
16. [Closing Thoughts](#org00b4e44)
...
For convenience, this file can be tangled to produce a Guile module, `emacs-d.scm`, which can serve as a useful reference for how to package the init configuration with its required dependencies. See [1.13](#orgfabaee3) for more info.
...
1.  Key Variables
    ...
    Capture templates! These help me collect information into Org files. Currently I only have 2 cookbook capture methods that are meant to be used with org-chef. See [extensions](#org02eccff) for how I extend org-mode.
...
The popular `flycheck` package helps me lint various files. I use this in conjunction with [lsp-mode](#orgaf3bd61) as the two are meant to work together.
...
I extend [web-mode](#orgcffb28f) to enhance the syntax highlighting for `.svelte` files.
...
I extend [web-mode](#orgcffb28f) to enhance highlighting in `.vue` files.
...
Load the file we created for custom vars in the [general settings](#org32db063).
